                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
                        <div className="flex items-center lg:mb-0 mb-10">
                            <div className="w-full">
                                <h4 className="text-sky-500 text-base  font-bold leading-6 mb-4 lg:text-left text-center">Contact Us</h4>
                                ...
                                <input type="text" className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4" placeholder="Name" onChange={handleChange} name="name" value={detail.name} />
                                <p className='text-red-400 text-xs px-5 mb-8'>{formError.name}</p>
                                <input type="email" className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-gray-200 focus:outline-none py-2 px-4 " placeholder="Email" onChange={handleChange} name="email" value={detail.email} />
                                <p className='text-red-400 text-xs px-5 mb-8'>{formError.email}</p>


                                <textarea id="text" className="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 " placeholder="Phone" onChange={handleChange} name="phone" value={detail.phone}></textarea>
                                <p className='text-red-400 text-xs px-5 mb-8'>{formError.phoneNumber}</p>


                                <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-sky-500 shadow transition-all duration-700 hover:bg-indigo-800" onClick={handleClick}>Submit</button>
                            </div>
                        </div>
                        <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat contact-bg ">
                            <div className="">
                                <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                                    <h3 className='text-center pb-5 font-bold text-xl text-sky-500'>ABC Car Wash</h3>
